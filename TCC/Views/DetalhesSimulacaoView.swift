    ...
    var body: some View {
        ScrollView(.vertical) {
            VStack {
                ...
                LinhaTabelaHorizontal(campo: "Percentual de Substituição de Água Potável", valor: "30%")
                LinhaTabelaHorizontal(campo: "Demanda Mensal de Água Pluvial (L)", valor: "4270,5")
                LinhaTabelaHorizontal(campo: "Capacidade do Reservatório de Água Pluvial (L)", valor: "600")
                LinhaTabelaHorizontal(campo: "Potencial Médio de Atendimento (%)", valor: "13,4%")
                LinhaTabelaHorizontal(campo: "Número de Meses Parcialmente Atendidos", valor: "11")
                LinhaTabelaHorizontal(campo: "Número de Meses Completamente Atendidos", valor: "0")
                LinhaTabelaHorizontal(campo: "Número de Meses Não Atendidos", valor: "1")
